...
let ExpList = [
  {corp:"Mécanique Baumoise de Précision", logo : mbpLogo, date:"2020-2022", title:"Software Engineer", 
  ...
  {corp:"Daher Aerospace", logo : daherLogo, date:"2019", title:"Intern", job:"Discovery Internship"},
  {corp:"Freelance", logo : freelanceLogo, date:"2017", title:"Freelance Tutor", job:"Mathematics tutoring"},
];

let EduList = [
  {school:"École nationale supérieure d'ingénieurs Sud-Alsace (ENSISA)", loc: "Mulhouse", date:"2023-2027", description:"Computer Science"},
    ...
    <div className="App-body">
      ...
      <div className="body-wrapper">
        <div className="body-left">
          ...
          <div style={{marginBottom:"10px"}}><img src={gmailLogo} style={{width:"20px"}} alt="img-cv"/> soukhratimarouane@gmail.com</div>
          <div><img src={phoneLogo} style={{width:"20px", margin:"-4px 0px"}} alt="img-cv"/> +33667569678</div>
